...
DOKAN_OPERATIONS_fields = []
for i in DOKAN_OPERATIONS.class_dict:
    DOKAN_OPERATIONS_fields.append((i,DOKAN_OPERATIONS.class_dict[i]))
DOKAN_OPERATIONS._fields_ = DOKAN_OPERATIONS_fields